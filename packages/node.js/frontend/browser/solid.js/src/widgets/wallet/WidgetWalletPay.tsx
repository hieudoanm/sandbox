...
export const WidgetWalletPay = () => {
  const icons = [
    <FaBrandsPaypal title="paypal" />,
    <FaBrandsApplePay title="apple-pay" />,
    <FaBrandsAmazonPay title="amazon-pay" />,
    <FaBrandsGooglePay title="laptop" />,
  ];
      ...
      <div class="flex h-full w-full flex-col px-8 py-6">
        <div class="grid grid-cols-2 items-center pb-2">
          <div class="col-span-1">
            <h1 class="text-center font-black">Pay</h1>
          </div>
          <div class="col-span-1">
