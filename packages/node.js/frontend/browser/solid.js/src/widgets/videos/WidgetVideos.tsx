...
export const WidgetVideos = () => {
  const icons = [
    <FaSolidMagnifyingGlass title="search" />,
    <FaSolidRectangleList title="subscriptions" />,
    <FaBrandsTiktok title="shorts" />,
    <FaSolidPlus title="add" />,
  ];
      ...
      <div class="flex h-full w-full flex-col px-8 py-6">
        <div class="grid grid-cols-2 pb-2">
          <div class="col-span-1">
            <h1 class="text-center font-black">Videos</h1>
          </div>
          <div class="col-span-1">
