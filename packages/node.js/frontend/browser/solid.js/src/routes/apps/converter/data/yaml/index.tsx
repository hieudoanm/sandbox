...
import { FaSolidBook, FaBrandsJs } from 'solid-icons/fa';
...
const YamlAppsPage = () => {
  const apps: NothingApp[] = [
    ...
    {
      id: 'converter-data-yaml-openapi2postmanv2',
      href: 'converter/data/yaml/openapi2postmanv2',
