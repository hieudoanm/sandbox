...
import { FaBrandsMarkdown, FaBrandsSquareJs } from 'solid-icons/fa';
import { NothingApp } from '~/types';

const EditorAppsPage = () => {
  const apps: NothingApp[] = [
    {
      ...
      name: 'manifest.json',
      shortName: 'manifest',
      icon: <FaBrandsSquareJs class="text-xl md:text-2xl" />,
    },
    {
      id: 'editor-markdown',
