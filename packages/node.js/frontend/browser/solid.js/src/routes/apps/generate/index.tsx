...
import { FaSolidQrcode, FaSolidU } from 'solid-icons/fa';
  ...
  const apps: NothingApp[] = [
    {
      ...
      name: 'QR Code',
      shortName: 'qr.code',
      icon: <FaSolidQrcode class="text-xl md:text-2xl" />,
    },
    {
      id: 'generate-uuid',
      href: 'generate/uuid',
      name: 'UUID',
      shortName: 'uuid',
      icon: <FaSolidU class="text-xl md:text-2xl" />,
    },
  ];
...
export default GenerateAppsPage;
