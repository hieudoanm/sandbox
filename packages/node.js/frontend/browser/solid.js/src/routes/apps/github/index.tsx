...
import { FaSolidImage, FaSolidLanguage } from 'solid-icons/fa';
import { A } from '@solidjs/router';

const GitHubAppsPage = () => {
  const apps: NothingApp[] = [
    ...
    },
    {
      ...
      name: 'Languages',
      shortName: 'languages',
      icon: <FaSolidLanguage class="text-xl md:text-2xl" />,
    },
  ];
